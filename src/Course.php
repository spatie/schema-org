...
class Course extends BaseType implements CreativeWorkContract, ThingContract
{
     ...
     * [[AlignmentObject]].
     *
     * @param AlignmentObjectContract|AlignmentObjectContract[]|CourseContract|CourseContract[]|string|string[] $coursePrerequisites
     *
     * @return static
     *
     ...
     *
     * @param CourseInstanceContract|CourseInstanceContract[] $hasCourseInstance
     *
     * @return static
     *
