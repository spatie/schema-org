 ...
 *
 */
class MotorcycleDealer extends BaseType implements AutomotiveBusinessContract, LocalBusinessContract, MotorcycleDealerContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
