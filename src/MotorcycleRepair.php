 ...
 *
 */
class MotorcycleRepair extends BaseType implements AutomotiveBusinessContract, LocalBusinessContract, MotorcycleRepairContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
