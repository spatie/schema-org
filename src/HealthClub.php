 ...
 *
 */
class HealthClub extends BaseType implements HealthAndBeautyBusinessContract, HealthClubContract, LocalBusinessContract, OrganizationContract, PlaceContract, SportsActivityLocationContract, ThingContract
{
    /**
