...
use Spatie\SchemaOrg\Contracts\ShippingServiceContract;
 ...
 *
 */
class ShippingService extends BaseType implements ShippingServiceContract, IntangibleContract, StructuredValueContract, ThingContract
{
    /**
    ...
    {
        return $this->setProperty('fulfillmentType', $fulfillmentType);
    }
    ...
    {
        return $this->setProperty('shippingConditions', $shippingConditions);
    }
