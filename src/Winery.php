 ...
 *
 */
class Winery extends BaseType implements FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract, WineryContract
{
    /**
