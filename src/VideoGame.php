...
class VideoGame extends BaseType implements CreativeWorkContract, GameContract, SoftwareApplicationContract, ThingContract
{
     ...
     *
     * @param PersonContract|PersonContract[] $actors
     *
     * @return static
     *
     ...
     *
     * @param ThingContract|ThingContract[] $characterAttribute
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[] $cheatCode
     *
     * @return static
     *
     ...
     *
     * @param PersonContract|PersonContract[] $directors
     *
     * @return static
     *
     ...
     *
     * @param ThingContract|ThingContract[] $gameItem
     *
     * @return static
     *
     ...
     *
     * @param PlaceContract|PlaceContract[]|PostalAddressContract|PostalAddressContract[]|string|string[] $gameLocation
     *
     * @return static
     *
     ...
     * games</a>.
     *
     * @param ThingContract|ThingContract[]|string|string[] $gamePlatform
     *
     * @return static
     *
     ...
     *
     * @param GameServerContract|GameServerContract[] $gameServer
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[] $gameTip
     *
     * @return static
     *
     ...
     *
     * @param MusicGroupContract|MusicGroupContract[]|PersonContract|PersonContract[] $musicBy
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $numberOfPlayers
     *
     * @return static
     *
     ...
     * time.
     *
     * @param GamePlayModeContract|GamePlayModeContract[] $playMode
     *
     * @return static
     *
     ...
     *
     * @param ThingContract|ThingContract[] $quest
     *
     * @return static
     *
     ...
     *
     * @param ImageObjectContract|ImageObjectContract[]|string|string[] $screenshot
     *
     * @return static
     *
     ...
     *
     * @param SoftwareApplicationContract|SoftwareApplicationContract[] $softwareAddOn
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[] $softwareHelp
     *
     * @return static
     *
     ...
     *
     * @param DataFeedContract|DataFeedContract[] $supportingData
     *
     * @return static
     *
     ...
     *
     * @param VideoObjectContract|VideoObjectContract[] $trailer
     *
     * @return static
     *
