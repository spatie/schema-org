 ...
 *
 */
class SportsActivityLocation extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, SportsActivityLocationContract, ThingContract
{
    /**
