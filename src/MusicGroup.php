...
class MusicGroup extends BaseType implements OrganizationContract, PerformingGroupContract, ThingContract
{
     ...
     * A music album.
     *
     * @param MusicAlbumContract|MusicAlbumContract[] $album
     *
     * @return static
     *
     ...
     *
     * @param MusicAlbumContract|MusicAlbumContract[] $albums
     *
     * @return static
     *
     ...
     * Ringo.
     *
     * @param PersonContract|PersonContract[] $musicGroupMember
     *
     * @return static
     *
