 ...
 *
 */
class RadioSeries extends BaseType implements CreativeWorkContract, CreativeWorkSeriesContract, IntangibleContract, RadioSeriesContract, SeriesContract, ThingContract
{
    /**
