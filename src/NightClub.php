 ...
 *
 */
class NightClub extends BaseType implements EntertainmentBusinessContract, LocalBusinessContract, NightClubContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
