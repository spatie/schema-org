 ...
 *
 */
class OpeningHoursSpecification extends BaseType implements IntangibleContract, OpeningHoursSpecificationContract, StructuredValueContract, ThingContract
{
    /**
