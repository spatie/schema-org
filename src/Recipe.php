...
class Recipe extends BaseType implements CreativeWorkContract, HowToContract, ThingContract
{
     ...
     *
     * @param DurationContract|DurationContract[] $cookTime
     *
     * @return static
     *
     ...
     * instructions.
     *
     * @param MonetaryAmountContract|MonetaryAmountContract[]|string|string[] $estimatedCost
     *
     * @return static
     *
     ...
     *
     * @param NutritionInformationContract|NutritionInformationContract[] $nutrition
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[]|ItemListContract|ItemListContract[]|string|string[] $recipeInstructions
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|string|string[] $recipeYield
     *
     * @return static
     *
     ...
     * HowToSection.
     *
     * @param CreativeWorkContract|CreativeWorkContract[]|HowToSectionContract|HowToSectionContract[]|HowToStepContract|HowToStepContract[]|string|string[] $step
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[]|ItemListContract|ItemListContract[]|string|string[] $steps
     *
     * @return static
     *
     ...
     *
     * @param RestrictedDietContract|RestrictedDietContract[] $suitableForDiet
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|string|string[] $yield
     *
     * @return static
     *
