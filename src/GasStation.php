 ...
 *
 */
class GasStation extends BaseType implements AutomotiveBusinessContract, GasStationContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
