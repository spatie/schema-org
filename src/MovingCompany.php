 ...
 *
 */
class MovingCompany extends BaseType implements HomeAndConstructionBusinessContract, LocalBusinessContract, MovingCompanyContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
