...
class MusicRelease extends BaseType implements CreativeWorkContract, MusicPlaylistContract, ThingContract
{
     ...
     * Lady Gaga.
     *
     * @param OrganizationContract|OrganizationContract[]|PersonContract|PersonContract[] $creditedTo
     *
     * @return static
     *
     ...
     *
     * @param MusicReleaseFormatTypeContract|MusicReleaseFormatTypeContract[] $musicReleaseFormat
     *
     * @return static
     *
     ...
     *
     * @param OrganizationContract|OrganizationContract[] $recordLabel
     *
     * @return static
     *
     ...
     *
     * @param MusicAlbumContract|MusicAlbumContract[] $releaseOf
     *
     * @return static
     *
