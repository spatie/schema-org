 ...
 *
 */
class MensClothingStore extends BaseType implements LocalBusinessContract, MensClothingStoreContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
