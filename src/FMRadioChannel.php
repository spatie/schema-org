 ...
 *
 */
class FMRadioChannel extends BaseType implements BroadcastChannelContract, FMRadioChannelContract, IntangibleContract, RadioChannelContract, ThingContract
{
    /**
