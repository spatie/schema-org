 ...
 *
 */
class MovieRentalStore extends BaseType implements LocalBusinessContract, MovieRentalStoreContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
