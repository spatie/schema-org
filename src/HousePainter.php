 ...
 *
 */
class HousePainter extends BaseType implements HomeAndConstructionBusinessContract, HousePainterContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
