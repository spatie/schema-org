 ...
 *
 */
class SportsClub extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, SportsActivityLocationContract, SportsClubContract, ThingContract
{
    /**
