...
class ViewAction extends BaseType implements ActionContract, ConsumeActionContract, ThingContract
{
     ...
     *
     * @param ActionAccessSpecificationContract|ActionAccessSpecificationContract[] $actionAccessibilityRequirement
     *
     * @return static
     *
     ...
     * it.
     *
     * @param OfferContract|OfferContract[] $expectsAcceptanceOf
     *
     * @return static
     *
