...
class Question extends BaseType implements CreativeWorkContract, ThingContract
{
     ...
     *
     * @param AnswerContract|AnswerContract[]|ItemListContract|ItemListContract[] $acceptedAnswer
     *
     * @return static
     *
     ...
     *
     * @param AnswerContract|AnswerContract[]|ItemListContract|ItemListContract[] $suggestedAnswer
     *
     * @return static
     *
