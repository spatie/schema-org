...
use Spatie\SchemaOrg\Contracts\AuthenticateActionContract;
 ...
 *
 */
class AuthenticateAction extends BaseType implements AuthenticateActionContract, ActionContract, ControlActionContract, ThingContract
{
    /**
