...
use Spatie\SchemaOrg\Contracts\SequentialArtContract;
use Spatie\SchemaOrg\Contracts\ThingContract;
use Spatie\SchemaOrg\Contracts\VisualArtworkContract;

/**
 * An art forms that use images deployed in a specific order for the purpose of
 * graphic storytelling (i.e., narration of graphic stories) or conveying
 ...
 *
 */
class SequentialArt extends BaseType implements SequentialArtContract, BookContract, CreativeWorkContract, ThingContract, VisualArtworkContract
{
    /**
