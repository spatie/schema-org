 ...
 *
 */
class DepositAccount extends BaseType implements BankAccountContract, DepositAccountContract, FinancialProductContract, IntangibleContract, InvestmentOrDepositContract, ServiceContract, ThingContract
{
    /**
