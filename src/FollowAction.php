 ...
 * actions:\n\n* [[BefriendAction]]: Unlike BefriendAction, FollowAction implies
 * that the connection is *not* necessarily reciprocal.\n* [[SubscribeAction]]:
 ...
 * refers to the polling of updates of all aspects of animate objects rather
 * than the location of inanimate objects (e.g. you track a package, but you
 * don't follow it).
 *
