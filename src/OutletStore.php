 ...
 *
 */
class OutletStore extends BaseType implements LocalBusinessContract, OrganizationContract, OutletStoreContract, PlaceContract, StoreContract, ThingContract
{
    /**
