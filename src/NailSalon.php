 ...
 *
 */
class NailSalon extends BaseType implements HealthAndBeautyBusinessContract, LocalBusinessContract, NailSalonContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
