 ...
 *
 */
class PublicSwimmingPool extends BaseType implements SportsActivityLocationContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
