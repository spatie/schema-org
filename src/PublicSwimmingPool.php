 ...
 *
 */
class PublicSwimmingPool extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, PublicSwimmingPoolContract, SportsActivityLocationContract, ThingContract
{
    /**
