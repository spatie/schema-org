...
use Spatie\SchemaOrg\Contracts\LoginActionContract;
 ...
 *
 */
class LoginAction extends BaseType implements LoginActionContract, ActionContract, ControlActionContract, ThingContract
{
    /**
