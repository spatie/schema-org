...
class MusicRecording extends BaseType implements CreativeWorkContract, ThingContract
{
     ...
     *
     * @param MusicAlbumContract|MusicAlbumContract[] $inAlbum
     *
     * @return static
     *
     ...
     *
     * @param MusicPlaylistContract|MusicPlaylistContract[] $inPlaylist
     *
     * @return static
     *
     ...
     *
     * @param MusicCompositionContract|MusicCompositionContract[] $recordingOf
     *
     * @return static
     *
