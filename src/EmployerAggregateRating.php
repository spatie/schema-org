 ...
 *
 */
class EmployerAggregateRating extends BaseType implements AggregateRatingContract, EmployerAggregateRatingContract, IntangibleContract, RatingContract, ThingContract
{
    /**
