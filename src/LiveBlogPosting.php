 ...
 *
 */
class LiveBlogPosting extends BaseType implements ArticleContract, BlogPostingContract, CreativeWorkContract, LiveBlogPostingContract, SocialMediaPostingContract, ThingContract
{
    /**
