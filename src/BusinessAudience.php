...
class BusinessAudience extends BaseType implements AudienceContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param AdministrativeAreaContract|AdministrativeAreaContract[] $geographicArea
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $yearlyRevenue
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $yearsInOperation
     *
     * @return static
     *
