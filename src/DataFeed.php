...
class DataFeed extends BaseType implements CreativeWorkContract, DatasetContract, ThingContract
{
     ...
     *
     * @param DataCatalogContract|DataCatalogContract[] $catalog
     *
     * @return static
     *
     ...
     *
     * @param DataFeedItemContract|DataFeedItemContract[]|ThingContract|ThingContract[]|string|string[] $dataFeedElement
     *
     * @return static
     *
     ...
     * specific format.
     *
     * @param DataDownloadContract|DataDownloadContract[] $distribution
     *
     * @return static
     *
     ...
     *
     * @param DataCatalogContract|DataCatalogContract[] $includedDataCatalog
     *
     * @return static
     *
     ...
     * A data catalog which contains this dataset.
     *
     * @param DataCatalogContract|DataCatalogContract[] $includedInDataCatalog
     *
     * @return static
     *
