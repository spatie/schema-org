...
use Spatie\SchemaOrg\Contracts\OperatingSystemContract;
 ...
 *
 */
class OperatingSystem extends BaseType implements OperatingSystemContract, CreativeWorkContract, SoftwareApplicationContract, ThingContract
{
    /**
