...
class DigitalDocumentPermission extends BaseType implements IntangibleContract, ThingContract
{
     ...
     *
     * @param AudienceContract|AudienceContract[]|ContactPointContract|ContactPointContract[]|OrganizationContract|OrganizationContract[]|PersonContract|PersonContract[] $grantee
     *
     * @return static
     *
     ...
     *
     * @param DigitalDocumentPermissionTypeContract|DigitalDocumentPermissionTypeContract[] $permissionType
     *
     * @return static
     *
