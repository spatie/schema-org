...
class SoftwareSourceCode extends BaseType implements CreativeWorkContract, ThingContract
{
     ...
     *
     * @param ComputerLanguageContract|ComputerLanguageContract[]|string|string[] $programmingLanguage
     *
     * @return static
     *
     ...
     *
     * @param SoftwareApplicationContract|SoftwareApplicationContract[] $targetProduct
     *
     * @return static
     *
