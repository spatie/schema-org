...
use Spatie\SchemaOrg\Contracts\ServicePeriodContract;
 ...
 *
 */
class ServicePeriod extends BaseType implements ServicePeriodContract, IntangibleContract, StructuredValueContract, ThingContract
{
    /**
