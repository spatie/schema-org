 ...
 *
 */
class Hospital extends BaseType implements CivicStructureContract, EmergencyServiceContract, HospitalContract, LocalBusinessContract, MedicalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
