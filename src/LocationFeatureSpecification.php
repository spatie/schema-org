 ...
 *
 */
class LocationFeatureSpecification extends BaseType implements IntangibleContract, LocationFeatureSpecificationContract, PropertyValueContract, StructuredValueContract, ThingContract
{
    /**
