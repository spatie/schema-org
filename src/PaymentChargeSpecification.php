 ...
 *
 */
class PaymentChargeSpecification extends BaseType implements IntangibleContract, PaymentChargeSpecificationContract, PriceSpecificationContract, StructuredValueContract, ThingContract
{
    /**
