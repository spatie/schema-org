 ...
 *
 */
class TouristInformationCenter extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract, TouristInformationCenterContract
{
    /**
