...
class OwnershipInfo extends BaseType implements IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param OrganizationContract|OrganizationContract[]|PersonContract|PersonContract[] $acquiredFrom
     *
     * @return static
     *
     ...
     *
     * @param ProductContract|ProductContract[]|ServiceContract|ServiceContract[] $typeOfGood
     *
     * @return static
     *
