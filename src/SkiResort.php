 ...
 *
 */
class SkiResort extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, SkiResortContract, SportsActivityLocationContract, ThingContract
{
    /**
