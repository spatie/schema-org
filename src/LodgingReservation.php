...
class LodgingReservation extends BaseType implements IntangibleContract, ReservationContract, ThingContract
{
     ...
     * bed, etc.).
     *
     * @param QualitativeValueContract|QualitativeValueContract[]|string|string[] $lodgingUnitType
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|int|int[] $numAdults
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|int|int[] $numChildren
     *
     * @return static
     *
