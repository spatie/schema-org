...
class VideoGameSeries extends BaseType implements CreativeWorkContract, CreativeWorkSeriesContract, IntangibleContract, SeriesContract, ThingContract
{
     ...
     *
     * @param CreativeWorkSeasonContract|CreativeWorkSeasonContract[] $containsSeason
     *
     * @return static
     *
     ...
     *
     * @param EpisodeContract|EpisodeContract[] $episode
     *
     * @return static
     *
     ...
     *
     * @param EpisodeContract|EpisodeContract[] $episodes
     *
     * @return static
     *
     ...
     *
     * @param OrganizationContract|OrganizationContract[] $productionCompany
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkSeasonContract|CreativeWorkSeasonContract[] $season
     *
     * @return static
     *
     ...
     * A season in a media series.
     *
     * @param CreativeWorkSeasonContract|CreativeWorkSeasonContract[] $seasons
     *
     * @return static
     *
