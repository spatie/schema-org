 ...
 *
 */
class VideoGameSeries extends BaseType implements CreativeWorkContract, CreativeWorkSeriesContract, IntangibleContract, SeriesContract, ThingContract, VideoGameSeriesContract
{
    /**
