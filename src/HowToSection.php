...
class HowToSection extends BaseType implements CreativeWorkContract, IntangibleContract, ItemListContract, ListItemContract, ThingContract
{
     ...
     *
     * @param ListItemContract|ListItemContract[]|ThingContract|ThingContract[]|string|string[] $itemListElement
     *
     * @return static
     *
     ...
     *
     * @param ItemListOrderTypeContract|ItemListOrderTypeContract[]|string|string[] $itemListOrder
     *
     * @return static
     *
