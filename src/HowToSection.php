 ...
 *
 */
class HowToSection extends BaseType implements CreativeWorkContract, HowToSectionContract, IntangibleContract, ItemListContract, ListItemContract, ThingContract
{
    /**
