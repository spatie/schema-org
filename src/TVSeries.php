 ...
 *
 */
class TVSeries extends BaseType implements CreativeWorkContract, CreativeWorkSeriesContract, CreativeWorkContract, SeriesContract, IntangibleContract, ThingContract
{
    /**
