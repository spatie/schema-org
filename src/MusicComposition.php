...
class MusicComposition extends BaseType implements CreativeWorkContract, ThingContract
{
     ...
     *
     * @param EventContract|EventContract[] $firstPerformance
     *
     * @return static
     *
     ...
     * symphony).
     *
     * @param MusicCompositionContract|MusicCompositionContract[] $includedComposition
     *
     * @return static
     *
     ...
     *
     * @param PersonContract|PersonContract[] $lyricist
     *
     * @return static
     *
     ...
     *
     * @param CreativeWorkContract|CreativeWorkContract[] $lyrics
     *
     * @return static
     *
     ...
     *
     * @param MusicCompositionContract|MusicCompositionContract[] $musicArrangement
     *
     * @return static
     *
     ...
     *
     * @param MusicRecordingContract|MusicRecordingContract[] $recordedAs
     *
     * @return static
     *
