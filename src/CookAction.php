...
class CookAction extends BaseType implements ActionContract, CreateActionContract, ThingContract
{
     ...
     * action occurred.
     *
     * @param FoodEstablishmentContract|FoodEstablishmentContract[]|PlaceContract|PlaceContract[] $foodEstablishment
     *
     * @return static
     *
     ...
     * occurred.
     *
     * @param FoodEventContract|FoodEventContract[] $foodEvent
     *
     * @return static
     *
     ...
     * action.
     *
     * @param RecipeContract|RecipeContract[] $recipe
     *
     * @return static
     *
