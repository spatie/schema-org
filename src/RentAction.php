...
class RentAction extends BaseType implements ActionContract, ThingContract, TradeActionContract
{
     ...
     *
     * @param OrganizationContract|OrganizationContract[]|PersonContract|PersonContract[] $landlord
     *
     * @return static
     *
     ...
     * action.
     *
     * @param RealEstateAgentContract|RealEstateAgentContract[] $realEstateAgent
     *
     * @return static
     *
