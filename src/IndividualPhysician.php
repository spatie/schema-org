...
use Spatie\SchemaOrg\Contracts\IndividualPhysicianContract;
 ...
 *
 */
class IndividualPhysician extends BaseType implements IndividualPhysicianContract, MedicalOrganizationContract, OrganizationContract, PhysicianContract, ThingContract
{
    /**
