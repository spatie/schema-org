 ...
 *
 */
class LegislativeBuilding extends BaseType implements CivicStructureContract, GovernmentBuildingContract, LegislativeBuildingContract, PlaceContract, ThingContract
{
    /**
