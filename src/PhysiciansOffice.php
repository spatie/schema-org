...
use Spatie\SchemaOrg\Contracts\PhysiciansOfficeContract;
 ...
 *
 */
class PhysiciansOffice extends BaseType implements PhysiciansOfficeContract, MedicalOrganizationContract, OrganizationContract, PhysicianContract, ThingContract
{
    /**
