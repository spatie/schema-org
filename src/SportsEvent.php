...
class SportsEvent extends BaseType implements EventContract, ThingContract
{
     ...
     *
     * @param PersonContract|PersonContract[]|SportsTeamContract|SportsTeamContract[] $awayTeam
     *
     * @return static
     *
     ...
     *
     * @param PersonContract|PersonContract[]|SportsTeamContract|SportsTeamContract[] $competitor
     *
     * @return static
     *
     ...
     *
     * @param PersonContract|PersonContract[]|SportsTeamContract|SportsTeamContract[] $homeTeam
     *
     * @return static
     *
