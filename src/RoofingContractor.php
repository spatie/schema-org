 ...
 *
 */
class RoofingContractor extends BaseType implements HomeAndConstructionBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, RoofingContractorContract, ThingContract
{
    /**
