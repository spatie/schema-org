...
use Spatie\SchemaOrg\Contracts\ConferenceEventContract;
 ...
 *
 */
class ConferenceEvent extends BaseType implements ConferenceEventContract, EventContract, ThingContract
{
    /**
