 ...
 *
 */
class QuantitativeValueDistribution extends BaseType implements IntangibleContract, QuantitativeValueDistributionContract, StructuredValueContract, ThingContract
{
    /**
