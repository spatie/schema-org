 ...
 *
 */
class MonetaryAmountDistribution extends BaseType implements IntangibleContract, MonetaryAmountDistributionContract, QuantitativeValueDistributionContract, StructuredValueContract, ThingContract
{
    /**
