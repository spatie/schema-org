...
class Vehicle extends BaseType implements ProductContract, ThingContract
{
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $cargoVolume
     *
     * @return static
     *
     ...
     *
     * @param DriveWheelConfigurationValueContract|DriveWheelConfigurationValueContract[]|string|string[] $driveWheelConfiguration
     *
     * @return static
     *
     ...
     * another value.
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $fuelConsumption
     *
     * @return static
     *
     ...
     * value.
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $fuelEfficiency
     *
     * @return static
     *
     ...
     * to the vehicle.
     *
     * @param QualitativeValueContract|QualitativeValueContract[]|string|string[] $fuelType
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[] $mileageFromOdometer
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|float|float[]|int|int[] $numberOfAxles
     *
     * @return static
     *
     ...
     * Typical unit code(s): C62
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|float|float[]|int|int[] $numberOfDoors
     *
     * @return static
     *
     ...
     * Typical unit code(s): C62
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|float|float[]|int|int[] $numberOfForwardGears
     *
     * @return static
     *
     ...
     * Typical unit code(s): C62
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|float|float[]|int|int[] $numberOfPreviousOwners
     *
     * @return static
     *
     ...
     *
     * @param SteeringPositionValueContract|SteeringPositionValueContract[] $steeringPosition
     *
     * @return static
     *
     ...
     *
     * @param EngineSpecificationContract|EngineSpecificationContract[] $vehicleEngine
     *
     * @return static
     *
     ...
     *
     * @param QuantitativeValueContract|QuantitativeValueContract[]|float|float[]|int|int[] $vehicleSeatingCapacity
     *
     * @return static
     *
     ...
     * cars).
     *
     * @param QualitativeValueContract|QualitativeValueContract[]|string|string[] $vehicleTransmission
     *
     * @return static
     *
