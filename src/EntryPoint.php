...
class EntryPoint extends BaseType implements IntangibleContract, ThingContract
{
     ...
     *
     * @param SoftwareApplicationContract|SoftwareApplicationContract[] $actionApplication
     *
     * @return static
     *
     ...
     * An application that can complete the request.
     *
     * @param SoftwareApplicationContract|SoftwareApplicationContract[] $application
     *
     * @return static
     *
