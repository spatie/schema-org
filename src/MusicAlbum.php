...
class MusicAlbum extends BaseType implements CreativeWorkContract, MusicPlaylistContract, ThingContract
{
     ...
     *
     * @param MusicAlbumProductionTypeContract|MusicAlbumProductionTypeContract[] $albumProductionType
     *
     * @return static
     *
     ...
     *
     * @param MusicReleaseContract|MusicReleaseContract[] $albumRelease
     *
     * @return static
     *
     ...
     *
     * @param MusicAlbumReleaseTypeContract|MusicAlbumReleaseTypeContract[] $albumReleaseType
     *
     * @return static
     *
     ...
     *
     * @param MusicGroupContract|MusicGroupContract[]|PersonContract|PersonContract[] $byArtist
     *
     * @return static
     *
     ...
     *
     * @param ItemListContract|ItemListContract[]|MusicRecordingContract|MusicRecordingContract[] $track
     *
     * @return static
     *
     ...
     *
     * @param MusicRecordingContract|MusicRecordingContract[] $tracks
     *
     * @return static
     *
