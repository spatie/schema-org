...
use Spatie\SchemaOrg\Contracts\OnlineMarketplaceContract;
 ...
 *
 */
class OnlineMarketplace extends BaseType implements OnlineMarketplaceContract, OnlineBusinessContract, OnlineStoreContract, OrganizationContract, ThingContract
{
    /**
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/4470
     */
    public function hasStore($hasStore)
    {
        return $this->setProperty('hasStore', $hasStore);
    }
