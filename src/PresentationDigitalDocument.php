 ...
 *
 */
class PresentationDigitalDocument extends BaseType implements CreativeWorkContract, DigitalDocumentContract, PresentationDigitalDocumentContract, ThingContract
{
    /**
