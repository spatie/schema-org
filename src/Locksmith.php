 ...
 *
 */
class Locksmith extends BaseType implements HomeAndConstructionBusinessContract, LocalBusinessContract, LocksmithContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
