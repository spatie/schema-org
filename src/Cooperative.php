...
use Spatie\SchemaOrg\Contracts\CooperativeContract;
 ...
 *
 */
class Cooperative extends BaseType implements CooperativeContract, OrganizationContract, ThingContract
{
    /**
