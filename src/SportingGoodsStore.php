 ...
 *
 */
class SportingGoodsStore extends BaseType implements LocalBusinessContract, OrganizationContract, PlaceContract, SportingGoodsStoreContract, StoreContract, ThingContract
{
    /**
